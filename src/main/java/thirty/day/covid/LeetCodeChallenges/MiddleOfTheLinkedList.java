...
public class MiddleOfTheLinkedList {
	...
	/*
	 * Use two pointer slow and fast initialize both to head of LinkedList. Move
	 * fast by 2 step and slow by 1 step. When fast pointer reaches end then slow
	 * will be on middle node.
	 */
